      ...
      <section id='home'>
        ...
        >
          <div
            ...
            ref={introRef}
          >
            <p className='py-2 text-4xl md:text-8xl font-semibold font-sans'>
               Amaury Silva
            </p>
            {/* Profile Name */}
            <p className='text-2xl md:text-5xl py-2 font-semibold font-sans text-[#c72c6c] dark:text-[#07d0e5]'>
              I&apos;m a Senior Full Stack developer |{" "} 10 years
            </p>
            <div className='mt-5 md:mt-10 flex gap-3'>
              {/* Hire Me Button */}
              <Link
                className='text-white text-3xl font-semibold rounded border border-red-500 hover:text-white hover:bg-red-500 px-2 py-1'
                href={"#getInTouch"}
              >
                SEND MESSAGE
              </Link>
