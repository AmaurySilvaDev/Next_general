      ...
      >
        ...
        <div className='pb-[30px] px-[20px] md:px-[100px] lg:px-[200px] md:flex gap-[50px]'>
          ...
          >
            ...
            {/* Profil Name */}
            <p className='text-center md:text-left text-[#c72c6c] dark:text-[#07d0e5] mt-1'>
            ...
            <div className='mt-5 justify-evenly text-justify'>
              ...
              I am a seasoned Senior Software Engineer based in Louisville, Kentucky, 
              with over a decade of experience in the development field, starting from June 2013. 
              Recognized for my individual talent development and adept problem-solving skills, 
              I specialize in crafting top-tier products. My passion for software development is 
              fueled by the dynamic nature of technology and the satisfaction of creating efficient, 
              scalable solutions. Committed to continuous improvement, I strive to pioneer innovation 
              and excel in every individual project.
              </p>
            </div>
          </div>
        </div>
